...
public class Vista extends javax.swing.JFrame {
    private VistaController controlador;
    ...
    // Sobrescribir solo el paintComponent
    javax.swing.JPanel real = panelSnake;
    ...
    panelSnake = new javax.swing.JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (ElementosSnake e : elementosDibujables) {
                e.dibujar(g);
            }
        }
    };
    ...
    // Mantener tamaño y posición exacta del diseño
    panelSnake.setBounds(real.getBounds());
    panelGeneral.add(panelSnake);
    panelGeneral.revalidate();
    panelGeneral.repaint();

    controlador = new VistaController(this); 
}
    ...
    private void btnObjectsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObjectsActionPerformed
     controlador.inicializarObjetos();      
